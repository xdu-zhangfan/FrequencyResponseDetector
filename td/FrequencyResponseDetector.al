...
<Project Version="3" Minor="2" Path="D:/Tasks/FrequencyResponseDetector/td">
    ...
    <Source_Files>
        <Verilog>
            ...
            <File Path="src/spi/spi_master.v">
                <FileInfo>
                    <Attr Name="UsedInSyn" Val="true"/>
                    <Attr Name="UsedInP&R" Val="true"/>
                    <Attr Name="BelongTo" Val="design_1"/>
        ...
        <IP_FILE>
            ...
            <File Path="al_ip/dds_adc_dsp_0.ipc">
                <FileInfo>
                    <Attr Name="UsedInSyn" Val="true"/>
                    <Attr Name="UsedInP&R" Val="true"/>
                    <Attr Name="BelongTo" Val="design_1"/>
            ...
            <File Path="al_ip/dds_divider_0.ipc">
                <FileInfo>
                    <Attr Name="UsedInSyn" Val="true"/>
                    <Attr Name="UsedInP&R" Val="true"/>
                    <Attr Name="BelongTo" Val="design_1"/>
    ...
    <Configurations>
        <Startup1>
            <non_jtag_persist>spix4</non_jtag_persist>
        </Startup1>
    </Configurations>
    <Runs>
