 ...
 ** File	:	/data/Tasks/FrequencyResponseDetector/td/al_ip/adc_core_fifo_0.v
 ** Date	:	2023 07 14
...
module adc_core_fifo_0 #(parameter DATA_WIDTH_W = 32, 
    ...
    fifo_cross_domain_addr_process_al_adc_core_fifo_0 #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_adc_core_fifo_0 #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_adc_core_fifo_0 #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_adc_core_fifo_0 #(parameter ADDR_WIDTH = 9) (
...
// ===========================================================================
module ram_infer_adc_core_fifo_0 (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
